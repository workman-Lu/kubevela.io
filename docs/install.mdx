...
helm install -n vela-system kubevela kubevela/vela-core --version 1.2.2 --wait
```
...
```shell script
curl -fsSl https://kubevela.io/script/install.sh | bash -s 1.2.2
```
